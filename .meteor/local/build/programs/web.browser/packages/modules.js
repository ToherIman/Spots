...
install("reactive-var");                                                     // 75
install("blaze");                                                            // 76
install("accounts-base", "meteor/accounts-base/client_main.js");             // 77
install("url");                                                              // 78
install("oauth");                                                            // 79
install("accounts-oauth");                                                   // 80
install("service-configuration");                                            // 81
install("spacebars");                                                        // 82
install("templating");                                                       // 83
install("npm-bcrypt");                                                       // 84
install("sha");                                                              // 85
install("srp");                                                              // 86
install("accounts-password");                                                // 87
install("less");                                                             // 88
install("accounts-ui-unstyled");                                             // 89
install("accounts-ui");                                                      // 90
install("oauth2");                                                           // 91
install("mrt:accounts-vk");                                                  // 92
install("facebook");                                                         // 93
install("accounts-facebook");                                                // 94
install("dburles:google-maps");                                              // 95
install("mdg:geolocation");                                                  // 96
install("standard-minifier-css");                                            // 97
install("standard-minifier-js");                                             // 98
install("webapp");                                                           // 99
install("livedata");                                                         // 100
install("hot-code-push");                                                    // 101
install("launch-screen");                                                    // 102
install("ui");                                                               // 103
install("autoupdate");                                                       // 104
                                                                             // 105
///////////////////////////////////////////////////////////////////////////////
